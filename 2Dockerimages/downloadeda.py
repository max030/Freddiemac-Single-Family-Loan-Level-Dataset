...
def preprocessingCsvFiles(filetype):
  with open(DIR_NAME + '/unprocessed_consolidated_sample_' + filetype + '_file.csv', 'rb') as sourceCsvFile:
      ...
      with open(DIR_NAME + '/processed_consolidated_sample_' + filetype + '_file.csv',
          ...
          for r in rdr:
              if (filetype == 'svcg'):
                  wtr.writerow((r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[8], r[9], r[10], r[11], r[13],
                                r[14], r[15], r[16], r[17], r[18], r[19], r[21]))
              else:
                  wtr.writerow((
                               r[0], r[1], r[3], r[5], r[8], r[9], r[10], r[11], r[12], r[14], r[15], r[16],
                               r[19], r[20], r[21], r[24]))
...
if __name__ == "__main__":
    ...
    #plotGraph()
os.system("python datawranglingeda.py")